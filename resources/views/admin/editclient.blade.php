...
<html class="h-full">
<head>
    <title>Edit Clients | Courier Service</title>
    <meta charset="UTF-8">
    ...
    <div class="py-10">
        <header>
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold leading-tight tracking-tight text-gray-900">Edit Client</h1>
            </div>
        </header>
        <main>
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <form method="POST" action="{{ route('client.update', ['id' => $user->id]) }}">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        ...
                        <button  class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Edit</button>
                    </div>
