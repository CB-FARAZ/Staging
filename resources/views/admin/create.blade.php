                                ...
                                <div class="mt-6 flex flex-col gap-5.5 sm:flex-row">
                                    ...
                                    <div class="w-full sm:w-1/2 mx-2">
                                        ...
                                        <div class="w-full sm:w-10/12 mx-12">
                                            <label for="role" class="mb-3 block text-md font-semibold font-medium ">Role</label>
                                    ...
                                    <div class="w-full sm:w-1/2 mx-2">
                                        <div class="w-full sm:w-10/12 mx-12">
                                            <label for="status" class="mb-3 block text-md font-semibold font-medium ">Status</label>
